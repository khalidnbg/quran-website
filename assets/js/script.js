...
async function getReciters() {
  const chooseReciter = document.querySelector("#chooseReciters");
...
function playLive(channel) {
  if (Hls.isSupported()) {
    ...
    var hls = new Hls();
    hls.loadSource(channel); // Use the provided channel directly
